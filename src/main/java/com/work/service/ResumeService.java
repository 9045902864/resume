...
import com.work.resume.format.AddressHeader;
import com.work.resume.header.*;
...
public class ResumeService {
    ...
    public void create(ResumeFormDTO resumeFormDTOForm, HttpServletResponse response) {

        Document document = new Document();
        try {
            ResumeFormDTO resumeFormDTO = new ResumeFormDTO();
            response.setContentType("application/pdf");
//            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("cv.pdf"));
